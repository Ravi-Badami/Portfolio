const Contact = () => {
  return (
    <div id='messages'>
      <section className='text-gray-600 body-font relative bg-blue-50 rounded-xl '>
        <div className=' px-5 py-10 md:py-24 mx-auto'>
              ...
              <div className='p-2 w-full'>
                <div className='relative'>
                  ...
                  <textarea
                    id='message'
                    name='message'
                    className='w-full min-h-44 bg-gray-100 bg-opacity-50 rounded border border-black focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-auto text-base outline-none text-gray-700 py-1 px-3 leading-6 transition-colors duration-200 ease-in-out resize-both'></textarea>
                </div>
              </div>
              <div className='p-2 w-full'>
