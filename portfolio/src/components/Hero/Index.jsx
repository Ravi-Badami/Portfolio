      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
        ...
        <div className="bg-zinc-900 rounded-3xl p-6 md:p-8 border border-zinc-800 flex flex-col justify-between group overflow-hidden relative">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white text-lg md:text-2xl font-semibold">{heroData.status}</p>
          ...
          <Link 
            ...
            duration={500} 
            offset={-50}
            className="mt-4 md:mt-8 self-start px-3 py-1.5 md:px-6 md:py-2 bg-white text-zinc-900 rounded-full text-sm md:text-base font-medium hover:scale-105 transition-transform w-full md:w-auto text-center cursor-pointer relative z-20"
          >
            Contact Me
          </Link>
        </div>
        ...
        {/* Cell 4: Tech Stack */}
        <div className="col-span-2 bg-zinc-50 rounded-3xl p-6 md:p-10 border border-zinc-200 flex flex-col justify-between">
