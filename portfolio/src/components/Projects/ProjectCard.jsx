      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <div className="flex gap-3 mt-auto">
          <a 
            ...
            className="flex-1 inline-flex items-center justify-center px-4 py-2 bg-zinc-900 text-white rounded-lg font-medium text-sm hover:bg-zinc-800 transition-colors"
          >
            View Project
          </a>
          {project.github && (
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center px-3 py-2 bg-zinc-100 text-zinc-700 rounded-lg hover:bg-zinc-200 transition-colors"
